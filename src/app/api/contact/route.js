    ...
    try {
        ...
        try {
          ...
          `,
            ...
            if (res.error) {
                return new Response(
                    JSON.stringify({ error: 'Failed to send email', message: res.error.message }),
                    { status: 500 }
                );
            }
            ...
            return new Response(JSON.stringify({ error: 'Failed to send email', message: error.message }), {
                status: 500,
            });
        }
