                    ...
                    <div className='flex flex-col sm:flex-row gap-5'>
                        <div className='w-full xl:w-2/3 rounded-4xl p-5 xl:p-10 heading-text text-center bg-[#332b28]'>
                            ...
                            <div className='space-y-5 mt-5'>
                                ...
                                <p className='w-[90%] mx-auto text-sm sm:text-base'>Years of working with trusted manufacturers worldwide, we know where to find the right product and how to get it to you.</p>
                            </div>
                        </div>
                        ...
                        <div className='w-full xl:w-1/3 rounded-4xl p-5 xl:p-10 heading-text text-center bg-[#332b28]'>
                            ...
                            <div className='space-y-5 mt-5'>
                                ...
                                <p className='w-[90%] mx-auto text-sm sm:text-base'>We build brands with depth, names, stories, and visuals that hold meaning and stay consistent across every touchpoint.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col sm:flex-row gap-5'>
                        ...
                        <div className='w-full xl:w-1/3 rounded-4xl p-5 xl:p-10 heading-text text-center bg-[#332b28]'>
                            ...
                            <div className='space-y-5 mt-5'>
                                ...
                                <p className='w-[90%] mx-auto text-sm sm:text-base'>Clean, functional websites that do what they’re supposed to, tell your story clearly and work across devices.</p>
                            </div>
                        </div>
                        ...
                        <div className='w-full xl:w-2/3 flex flex-col rounded-4xl p-5 xl:p-10 heading-text text-center bg-[#332b28]'>
                            <div className='space-y-5 mt-5 sm:mt-0'>
                                ...
                                <p className='w-[90%] mx-auto text-sm sm:text-base'>We don’t chase trends. We build steady, thoughtful presence that speaks to your audience and aligns with your brand.</p>
                            </div>
