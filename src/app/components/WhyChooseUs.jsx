    ...
    return (
        <div className='w-full xl:w-[70%] mx-auto xl:py-20'>
            <div className='text-center space-y-15 py-20'>
                ...
                <img src={brand.src} className='w-[95%] sm:h-[400px] lg:h-[500px] object-cover xl:w-[60%] xl:h-[450px] mx-auto' alt="" />
                <p className='w-[95%] text-sm lg:text-xl xl:text-2xl body-text mx-auto'>With global experience and creative precision, we turn ideas into impactful market ready solutions.
                </p>
            </div>
