...
const WhyChooseUs = () => {
    return (
        <div className='w-full xl:w-[70%] mx-auto xl:mt-20 py-10 xl:py-40'>
            <div className='text-center space-y-15 py-20'>
                ...
                <p className='w-[90%] text-base md:text-xl xl:w-[50%] xl:text-2xl body-text mx-auto'>With global experience and creative precision, we turn ideas into impactful market ready solutions.
                </p>
            </div>
