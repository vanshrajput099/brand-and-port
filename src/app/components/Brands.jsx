...
const Brands = () => {
    ...
    return (
        <div ref={introRef} style={{ background: `url(${brandBG.src})`, backgroundPosition: "center", backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }} className={`overflow-hidden w-full px-2 xl:px-0 mx-auto bg-black py-12 space-y-10 transition duration-1000 delay-200 ease-out transform ${introRefInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-40'}`}>
            <div className={`text-center body-text mt-5 w-[80%] mx-auto transition duration-1000 delay-200 ease-out transform ${descInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-40'}`} ref={descRef}>
