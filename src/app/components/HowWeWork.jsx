...
const HowWeWork = () => {
    ...
    return (
        <div className='overflow-x-hidden w-full xl:w-[75%] mx-auto bg-black flex flex-col items-center py-20' style={{ background: `url(${mainFrame.src})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
