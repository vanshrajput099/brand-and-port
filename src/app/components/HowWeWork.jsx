...
const HowWeWork = () => {
    ...
    return (
        <div className='w-full xl:w-[75%] mx-auto bg-black flex flex-col items-center py-20' style={{ background: `url(${mainFrame.src})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
            <div ref={ref} className={`text-center space-y-10 transition-all duration-1000 delay-200 ease-out transform ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-100'}`}>
