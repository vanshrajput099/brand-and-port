        ...
        <div className='px-2 xl:px-0 w-full mx-auto bg-black flex flex-col items-center pt-45 pb-10 space-y-5' style={{ background: `url(${mainFrame.src})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
            ...
            <div className='text-center space-y-5'>
                ...
                <div className='body-text w-[90%] xl:w-[70%] mx-auto space-y-5'>
                    ...
                    <button onClick={handleSchedule} className="hover:cursor-pointer orange-bg py-2 w-[50%] xl:py-3 xl:px-7 xl:w-fit text-sm xl:text-base rounded-3xl">Schedule A Call </button>
                </div>
            </div>
            <video
