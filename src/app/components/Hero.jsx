    ...
    return (
        <div className='overflow-x-hidden px-2 xl:px-0 w-full mx-auto bg-black flex flex-col items-center pt-45 pb-10 space-y-5' style={{ background: `url(${mainFrame.src})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
            ...
            <div ref={titleRef} className={`text-center space-y-5 w-[80%] mx-auto transition duration-1000 delay-500 ease-out transform ${titleInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} `}>
                <div
                    className='w-fit mx-auto px-10 select-none heading-text text-2xl md:text-5xl xl:text-7xl text-center font-medium md:leading-[3.5rem] xl:leading-[5.5rem] cursor-hover-target'
                >
                    <h1 className="cursor-hover-text transition-colors duration-300">Your Brand, Our Port</h1>
                    <h1 className='cursor-hover-text bg-gradient-to-b from-white via-black via-380% to-black bg-clip-text text-transparent'>Lets Navigate Success Together</h1>
                </div>
