        ...
        <div className='w-[98%] px-2 xl:px-0 xl:w-[70%] mx-auto py-20'>
            ...
            <div className='flex gap-5 mt-10'>
                ...
                {/* <div className='flex items-center'>
                    <div className='bg-[#1a1a1a] w-[550px] px-5 py-10 space-y-10 rounded-3xl'>
                        <img className='h-[60px] w-[80px]' src={quote.src} alt="" />
                        <p className='text-xl body-text'>The discovery phase was incredibly insightful. The team really took the time to understand our vision, and the strategy call helped us align our goals from day one. We felt heard and supported throughout the entire journey.</p>
                        <div>
                            <h1 className='font-medium text-xl'>Albert Flores</h1>
                            <h1 className='text-xl'>Founder; CREATIWISE</h1>
                        </div>
                    </div>
