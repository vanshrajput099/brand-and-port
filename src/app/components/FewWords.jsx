...
const FewWords = () => {
    ...
    return (
        <div ref={ref} className={`w-[98%] px-2 xl:px-0 xl:w-[70%] mx-auto py-20 relative transition duration-1000 delay-200 ease-out transform ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-y-10'}`}>
