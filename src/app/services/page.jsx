                    ...
                    SERVICES_DATA.map((ele, idx) => {
                        return (
                            <div key={idx} className='w-full sm:w-[45%] rounded-4xl p-5 space-y-4' style={{ background: `url(${mainFrame.src})`, backgroundPosition: "center", backgroundSize: 'cover' }}>
                                <img className='w-full h-[150px] lg:h-[250px] mx-auto object-cover' src={ele.img.src} alt="" />
                                <h1 className='text-xl lg:text-3xl font-medium'>{ele.name}</h1>
                                <p className='text-sm lg:text-base'>{ele.mssg}</p>
                            ...
                            return (
                                <Accordion key={idx} type="single" collapsible className={'bg-[#262120] rounded-4xl w-[90%] px-5 body-text'}>
                                    <AccordionItem value="item-1">
                                        <AccordionTrigger className={'orange-text'}>What is global sourcing and how can The Brand & Port help?</AccordionTrigger>
                                        <AccordionContent >
